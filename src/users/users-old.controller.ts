...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve paginated list of all users with optional filtering by role and search. Admin access required.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Update teacher verification status. Verified teachers get enhanced platform privileges and credibility badges.',
  })
  @ApiParam({
    name: 'id',
    ...
    schema: {
      ...
      properties: {
        isVerified: {
          type: 'boolean',
          description:
            'Whether to verify (true) or unverify (false) the teacher',
        },
      },
      required: ['isVerified'],
    },
