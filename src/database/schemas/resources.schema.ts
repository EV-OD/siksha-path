...
export const resources = pgTable(
  'resources',
  {
    ...
    accessLevel: resourceAccessEnum('access_level')
      .notNull()
      .default('enrolled'),
    ...
    downloadEnabled: varchar('download_enabled', { length: 10 })
      .notNull()
      .default('true'),
    viewOnlineEnabled: varchar('view_online_enabled', { length: 10 })
      .notNull()
      .default('true'),
...
export const resourceDownloads = pgTable(
  ...
  (table) => ({
    ...
    downloadTimeIdx: index('resource_downloads_time_idx').on(
      table.downloadedAt,
    ),
  }),
);
